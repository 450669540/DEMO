 ...
 * @LastEditTime: 2021-09-09 09:11:47
    ...
    <View >
      ...
      <View className='item'>
        ...
        <View className='yzmBtn' onClick={getYzm}>
          <Text className='itemText2'>{status ? '获取验证码' : `重新获取（${time}）`}</Text>
        </View>
      </View>
      <AtButton className='bindBtn' circle onClick={bindPhone}>绑定手机号</AtButton>
    </View>
  )
}
